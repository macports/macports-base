...
{
  return (size < TCL_SIZE_MAX) ? Tcl_NewStringObj(carray, (Tcl_Size)(size)) : NULL;
}
...
static swig_type_info _swigt__p_int = {"_p_int", "cpu_type_t *|int *", 0, 0, (void*)0, 0};
...
static swig_type_info _swigt__p_macho_handle = {"_p_macho_handle", "struct macho_handle *|macho_handle *", 0, 0, (void*)&_wrap_class_macho_handle, 0};
