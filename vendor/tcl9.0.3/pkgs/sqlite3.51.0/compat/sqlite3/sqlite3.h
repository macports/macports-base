...
#define SQLITE_SOURCE_ID      "2025-11-05 07:29:25 8a2d2690fc9c3f88e2e0fae6c50e01fd60b8920b895a3e876fe7db0c084fe8b6"
#define SQLITE_SCM_BRANCH     "trunk"
#define SQLITE_SCM_TAGS       ""
#define SQLITE_SCM_DATETIME   "2025-11-05T07:29:25.507Z"
...
struct fts5_api {
  ...
  int (*xCreateTokenizer_v2)(
    ...
    const char *zName,
    void *pUserData,
    const fts5_tokenizer_v2 *pTokenizer,
    void (*xDestroy)(void*)
  );
  ...
  int (*xFindTokenizer_v2)(
    ...
    const char *zName,
    void **ppUserData,
    const fts5_tokenizer_v2 **ppTokenizer
  );
};
