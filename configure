...
# Generated by GNU Autoconf 2.69 for MacPorts 2.1.3.
#
...
if test "$ac_init_help" = "long"; then
  ...
  cat <<_ACEOF
\`configure' configures MacPorts 2.1.3 to adapt to many kinds of systems.
...
if test -n "$ac_init_help"; then
  case $ac_init_help in
     short | recursive ) echo "Configuration of MacPorts 2.1.3:";;
   esac
  cat <<\_ACEOF
...
It was created by MacPorts $as_me 2.1.3, which was
...
ac_log="
This file was extended by MacPorts $as_me 2.1.3, which was
generated by GNU Autoconf 2.69.  Invocation command line was
